...
const features = [
  {
    ...
    description: "YOLOv8 computer vision monitors every frame of your live camera feed. Fire, accidents, and intrusions are flagged within 3 seconds — before a human operator would notice.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Blockchain Timestamping",
    description: "Every detected event is cryptographically hashed and immutably logged on Avalanche C-Chain. Sub-second finality means your evidence is on-chain before the smoke clears.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Decentralized Storage",
    description: "Video clips are stored on IPFS via Pinata — permanent, decentralized, and content-addressed. No central server holds the only copy of your evidence.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Court-Ready Evidence",
    description: "Export a complete evidence package: video clip, SHA-256 hash, blockchain proof, and signed manifest. Independently verifiable by any judge, lawyer, or insurance investigator.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Everything you need.
            <br />
            <span className="text-muted-foreground">Nothing gets past it.</span>
          </h2>
        </div>
